...
// ===== DZIKIR PAGI LENGKAP =====
List<DzikrItem> _buildDzikirPagiLengkap() {
  final items = <DzikrItem>[
    DzikrItem(
      repetitions: 1,
      titleId: "Ta'awudz",
...
final List<DzikrItem> dzikirPagiLengkapList = _buildDzikirPagiLengkap();

// ===== DZIKIR PETANG LENGKAP (AL-QUR'AN & HADITS) =====
List<DzikrItem> _buildDzikirPetangLengkap() {
  final items = <DzikrItem>[
    DzikrItem(
      repetitions: 1,
      titleId: "Ta'awudz",
...
final List<DzikrItem> dzikirPetangLengkapList = _buildDzikirPetangLengkap();
