...
class MainFlutterWindow: NSWindow {
  ...
  override func awakeFromNib() {
    ...
    recitationBridge = DarwinRecitationBridge(messenger: flutterViewController.engine.binaryMessenger)
    ...
    SFSpeechRecognizer.requestAuthorization { [weak self] status in
      ...
      DispatchQueue.main.async {
        guard status == .authorized else {
          result(FlutterError(code: "PERMISSION_DENIED", message: "Izin pengenalan suara ditolak.", details: nil))
          return
        }
